...
export const TYPE_COLORS: Record<
  ItemType,
  { bg: string; border: string; badge: string; description: string; rowAccent: string }
> = {
  PRODUCT: {
    ...
    rowAccent: 'border-l-2 border-l-blue-400 dark:border-l-blue-600',
  },
  EQUIPMENT: {
    ...
    rowAccent: 'border-l-2 border-l-purple-400 dark:border-l-purple-600',
  },
  TOOL: {
    ...
    rowAccent: 'border-l-2 border-l-orange-400 dark:border-l-orange-600',
  },
  KIT: {
    ...
    rowAccent: 'border-l-2 border-l-cyan-400 dark:border-l-cyan-600',
  },
};
