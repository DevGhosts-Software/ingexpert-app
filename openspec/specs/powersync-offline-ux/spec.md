# PowerSync Offline UX Spec — Ingexpert

> Covers cross-cutting local-first UX guarantees for final offline behavior validation across auth, inventory, and movements.
